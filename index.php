...
<div class="container">
    <form class="row" method="post" id="plagiarism-form">
        <input type="hidden" name="analyzeMethod" id="analyzeMethod">
        <div class="col-12">
            <h2 class="text-center my-4 font-weight-bold">Check paper for plagiarism</h2>
        </div>
            ...
            <div class="border w-50 border-dashed">
                <div class="row justify-content-center p-4">
                    <div class="d-flex flex-column w-50 align-items-center" id="file-upload-area">
                        <div class="border p-3 rounded-5 bg-primary-subtle">
                            <i class="fas fa-paperclip"></i>
                        </div>
                        <h4>Choose file</h4>
                        <div class="progress w-100" style="display: none;">
                            <div id="progressBar" class="progress-bar progress-bar-striped progress-bar-animated bg-danger h-100"
                    ...
                    <div class="col-12">
                        <textarea name="searchText" rows="5" class="form-control border-top" placeholder="Text for scan (min: 50 words, max: 800 words)"
                            id="contentTextarea" onfocus="hideFileUpload()" minlength="50" maxlength="800" onblur="showFileUpload()"></textarea>
                    </div>
                    <div class="col-12">
                        <i><small class="text-danger text-italicize" id="error-message"></small></i>
                    </div>
                    <div class="col-12 d-flex justify-content-center">
                        <button type="submit" class="btn btn-danger rounded-pill my-2 disabled d-flex justify-content-between align-items-center gap-2" id="submitBtn">
